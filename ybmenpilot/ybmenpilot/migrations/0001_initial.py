...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ybmenpilot_update', (
            ('post_id', self.gf('django.db.models.fields.TextField')(max_length=100, primary_key=True)),
    ...
    models = {
        ...
        u'ybmenpilot.update': {
            ...
            'post_id': ('django.db.models.fields.TextField', [], {'max_length': '100', 'primary_key': 'True'})
        }
    }
